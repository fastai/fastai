...
# %% ../nbs/13a_learner.ipynb #ccae9c14
...
# %% ../nbs/13a_learner.ipynb #fa1cf754
_all_ = ['CancelBackwardException', 'CancelStepException','CancelFitException','CancelEpochException',
         'CancelTrainException','CancelValidException','CancelBatchException']

# %% ../nbs/13a_learner.ipynb #0995972a
defaults.lr = 1e-3

# %% ../nbs/13a_learner.ipynb #807f958b
...
# %% ../nbs/13a_learner.ipynb #94542186
def mk_metric(m):
    "Convert `m` to an `AvgMetric`, unless it's already a `Metric`"
    if isinstance(m,type): m = m()
    return m if isinstance(m, Metric) else AvgMetric(m)

# %% ../nbs/13a_learner.ipynb #4af6f898
...
# %% ../nbs/13a_learner.ipynb #8ed3eb94
...
# %% ../nbs/13a_learner.ipynb #804db0ac
def _try_concat(o):
    try:    return torch.cat(o)
    except: return sum([L(o_[i,:] for i in range_of(o_)) for o_ in o], L())

# %% ../nbs/13a_learner.ipynb #73950e76
_before_epoch = [event.before_fit, event.before_epoch]
_after_epoch  = [event.after_epoch, event.after_fit]

# %% ../nbs/13a_learner.ipynb #ac049095
class _ConstantFunc():
    "Returns a function that returns `o`"
    def __init__(self, o): self.o = o
    def __call__(self, *args, **kwargs): return self.o

# %% ../nbs/13a_learner.ipynb #13d1bd5a
...
# %% ../nbs/13a_learner.ipynb #15b4a9d1
...
# %% ../nbs/13a_learner.ipynb #905db21a
...
# %% ../nbs/13a_learner.ipynb #acb7bd11
...
# %% ../nbs/13a_learner.ipynb #56584603
if not hasattr(defaults, 'callbacks'): defaults.callbacks = [TrainEvalCallback]

# %% ../nbs/13a_learner.ipynb #1bb2fafe
def _before_batch_cb(f, self):
    xb,yb = f(self, self.xb, self.yb)
    self.learn.xb,self.learn.yb = xb,yb

# %% ../nbs/13a_learner.ipynb #1704f9d3
def before_batch_cb(f):
    "Shortcut for creating a Callback on the `before_batch` event, which takes and returns `xb,yb`"
    return Callback(before_batch=partial(_before_batch_cb, f))

# %% ../nbs/13a_learner.ipynb #c57276a8
@patch
...
# %% ../nbs/13a_learner.ipynb #db171edf
@patch
...
# %% ../nbs/13a_learner.ipynb #9c591014
@patch
...
# %% ../nbs/13a_learner.ipynb #fbd6173a
...
# %% ../nbs/13a_learner.ipynb #87381eba
@docs
class Metric():
...
# %% ../nbs/13a_learner.ipynb #f3cb7c3a
...
# %% ../nbs/13a_learner.ipynb #786c20a2
...
# %% ../nbs/13a_learner.ipynb #da2b6bd6
...
# %% ../nbs/13a_learner.ipynb #8dc38c2f
...
# %% ../nbs/13a_learner.ipynb #372c6d7f
from fastprogress.fastprogress import format_time

# %% ../nbs/13a_learner.ipynb #2eb79f5c
def _maybe_item(t):
    t = t.value
    try: return t.item()
    except: return t

# %% ../nbs/13a_learner.ipynb #e0769a15
...
# %% ../nbs/13a_learner.ipynb #39371394
add_docs(Recorder,
...
# %% ../nbs/13a_learner.ipynb #f00be2db
def _cast_tensor(x): 
...
# %% ../nbs/13a_learner.ipynb #3a372740
...
# %% ../nbs/13a_learner.ipynb #af7622db
@patch
