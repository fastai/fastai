...
# %% ../nbs/12_optimizer.ipynb #444beee4
...
# %% ../nbs/12_optimizer.ipynb #2b6b4c09
...
# %% ../nbs/12_optimizer.ipynb #c7e2bb8d
def _update(
    state:dict,
...
# %% ../nbs/12_optimizer.ipynb #00601245
...
# %% ../nbs/12_optimizer.ipynb #2101f610
def sgd_step(p, lr, **kwargs):
    p.data.add_(p.grad.data, alpha=-lr)

# %% ../nbs/12_optimizer.ipynb #e4e3e19f
...
# %% ../nbs/12_optimizer.ipynb #5326b0f4
...
# %% ../nbs/12_optimizer.ipynb #0fb39759
...
# %% ../nbs/12_optimizer.ipynb #08a742e2
...
# %% ../nbs/12_optimizer.ipynb #d03ef3d6
def momentum_step(p, lr, grad_avg, **kwargs):
    "Step for SGD with momentum with `lr`"
    p.data.add_(grad_avg, alpha=-lr)

# %% ../nbs/12_optimizer.ipynb #7ad20b76
def SGD(
    params:Tensor|Iterable, # Model parameters
...
# %% ../nbs/12_optimizer.ipynb #8c3393c5
...
# %% ../nbs/12_optimizer.ipynb #e67a68d2
def RMSProp(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0., # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #45a46ce2
def step_stat(p, step=0, **kwargs):
    "Register the number of steps done in `state` for `p`"
    step += 1
    return {'step' : step}

# %% ../nbs/12_optimizer.ipynb #399f255c
def debias(mom, damp, step): return damp * (1 - mom**step) / (1-mom)

# %% ../nbs/12_optimizer.ipynb #033feea3
...
# %% ../nbs/12_optimizer.ipynb #93a5411a
def Adam(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
...
# %% ../nbs/12_optimizer.ipynb #ab442629
...
# %% ../nbs/12_optimizer.ipynb #30a6d5aa
def RAdam(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0.9, # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #421b7b28
...
# %% ../nbs/12_optimizer.ipynb #a8c8bad4
def QHAdam(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
...
# %% ../nbs/12_optimizer.ipynb #be6ff5e5
...
# %% ../nbs/12_optimizer.ipynb #5c099873
...
# %% ../nbs/12_optimizer.ipynb #a3a8bd4e
def Larc(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0.9, # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #a18f9409
...
# %% ../nbs/12_optimizer.ipynb #ba221122
def Lamb(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
    mom:float=0.9, # Gradient moving average (β1) coefficient
...
# %% ../nbs/12_optimizer.ipynb #f868defe
...
# %% ../nbs/12_optimizer.ipynb #29429cbe
@delegates(RAdam)
def ranger(
    params:Tensor|Iterable, # Model parameters
    lr:float|slice, # Default learning rate
...
# %% ../nbs/12_optimizer.ipynb #8e254628
def detuplify_pg(d):
    res = {}
    for k,v in d.items():
...
# %% ../nbs/12_optimizer.ipynb #d44c9d05
...
# %% ../nbs/12_optimizer.ipynb #80873fc6
