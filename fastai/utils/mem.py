...
# Original code improved from https://www.kaggle.com/gemartin/load-data-reduce-memory-usage
# Will reduce the dtypes down to the minimum size needed to run. Great for large datasets, helpful even for small ones.
def reduce_mem_usage(df):
    ...
    #Removed from debugging; Can be used to not touch certain values
    columns = df.columns
