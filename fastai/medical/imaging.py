...
__all__ = ['DcmDataset', 'DcmTag', 'DcmMultiValue', 'dcmread', 'get_dicom_files', 'DicomSegmentationDataLoader',
...
# Cell
#nbdev_comment _all_ = ['DcmDataset', 'DcmTag', 'DcmMultiValue', 'dcmread', 'get_dicom_files', 'DicomSegmentationDataLoader']
...
# Cell
class DicomSegmentationDataLoader(DataLoaders):
    "Basic wrapper around DICOM `DataLoader` with factory methods for segmentation problems"
    @classmethod
