...
def get_average_tree_depth(m):
    """ Returns the average tree depth of the trees in a random forest model
    
    Parameters:
    -----------
    m: the random forest model generated by sklearn

    Returns:
    --------
    An int that is the average tree depth of the trees
    ...
    >>> get_average_tree_depth(m) # 10.98
