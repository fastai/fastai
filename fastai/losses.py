...
__all__ = ['BaseLoss', 'CrossEntropyLossFlat', 'FocalLossFlat', 'BCEWithLogitsLossFlat', 'BCELossFlat', 'MSELossFlat',
           'L1LossFlat', 'LabelSmoothingCrossEntropy', 'LabelSmoothingCrossEntropyFlat', 'QuantileLoss']
...
class CrossEntropyLossFlat(BaseLoss):
    ...
    def activation(self, x): return tmax(x, dim=self.axis)
...
class QuantileLoss(Module):
    ...
    def forward(self, output, target):
        e = torch.sub(output, target)
        return torch.mean(torch.max(self.quantile * e, (self.quantile - 1) * e))