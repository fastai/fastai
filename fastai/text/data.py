...
# %% ../../nbs/31_text.data.ipynb #66254a01
...
# %% ../../nbs/31_text.data.ipynb #d05131c2
def reverse_text(x): return x.flip(0)

# %% ../../nbs/31_text.data.ipynb #5e1311d7
...
# %% ../../nbs/31_text.data.ipynb #2c50fc1f
...
# %% ../../nbs/31_text.data.ipynb #a72f6ce1
...
# %% ../../nbs/31_text.data.ipynb #49068ac7
def _maybe_first(o): return o[0] if isinstance(o, tuple) else o

# %% ../../nbs/31_text.data.ipynb #a8cc3608
...
# %% ../../nbs/31_text.data.ipynb #93df7c21
def _get_lengths(ds):
    tok = _get_tokenizer(ds)
    if tok is None: return
    return tok.get_lengths(ds.items)

# %% ../../nbs/31_text.data.ipynb #686aa232
#TODO: add backward
@delegates()
...
# %% ../../nbs/31_text.data.ipynb #1d8f5d44
@dispatch
...
# %% ../../nbs/31_text.data.ipynb #c17c0896
@dispatch
...
# %% ../../nbs/31_text.data.ipynb #9eabb188
...
# %% ../../nbs/31_text.data.ipynb #497dba0e
...
# %% ../../nbs/31_text.data.ipynb #8cbc90aa
@delegates(pad_chunk)
...
# %% ../../nbs/31_text.data.ipynb #c850f91c
...
# %% ../../nbs/31_text.data.ipynb #c20ce5b9
...
# %% ../../nbs/31_text.data.ipynb #cbbdf28c
...
# %% ../../nbs/31_text.data.ipynb #75de6cfb
