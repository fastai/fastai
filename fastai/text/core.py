...
# %% ../../nbs/30_text.core.ipynb #e36b779d
...
# %% ../../nbs/30_text.core.ipynb #ab9bcd6e
import html

# %% ../../nbs/30_text.core.ipynb #ff7d6c94
#special tokens
UNK, PAD, BOS, EOS, FLD, TK_REP, TK_WREP, TK_UP, TK_MAJ = "xxunk xxpad xxbos xxeos xxfld xxrep xxwrep xxup xxmaj".split()

# %% ../../nbs/30_text.core.ipynb #def6dcd4
_all_ = ["UNK", "PAD", "BOS", "EOS", "FLD", "TK_REP", "TK_WREP", "TK_UP", "TK_MAJ"]

# %% ../../nbs/30_text.core.ipynb #fe7f0d71
...
# %% ../../nbs/30_text.core.ipynb #5188ee0b
...
# %% ../../nbs/30_text.core.ipynb #8a40b131
...
# %% ../../nbs/30_text.core.ipynb #44cbfc1c
_re_wrep = re.compile(r'(?:\s|^)(\w+)\s+((?:\1\s+)+)\1(\s|\W|$)')

# %% ../../nbs/30_text.core.ipynb #ca5cf917
def replace_wrep(t):
...
# %% ../../nbs/30_text.core.ipynb #10006556
def fix_html(x):
...
# %% ../../nbs/30_text.core.ipynb #9515f579
_re_all_caps = re.compile(r'(\s|^)([A-Z]+[^a-z\s]*)(?=(\s|$))')

# %% ../../nbs/30_text.core.ipynb #18c71ca3
...
# %% ../../nbs/30_text.core.ipynb #96bcf071
_re_maj = re.compile(r'(\s|^)([A-Z][^A-Z\s]*)(?=(\s|$))')

# %% ../../nbs/30_text.core.ipynb #eedf2328
def replace_maj(t):
...
# %% ../../nbs/30_text.core.ipynb #65a599c0
def lowercase(t, add_bos=True, add_eos=False):
    "Converts `t` to lowercase"
    return (f'{BOS} ' if add_bos else '') + t.lower().strip() + (f' {EOS}' if add_eos else '')

# %% ../../nbs/30_text.core.ipynb #919c8d79
def replace_space(t):
    "Replace embedded spaces in a token with unicode line char to allow for split/join"
    return t.replace(' ', '▁')

# %% ../../nbs/30_text.core.ipynb #ca3fb387
...
# %% ../../nbs/30_text.core.ipynb #1ab3bbc9
class BaseTokenizer():
...
# %% ../../nbs/30_text.core.ipynb #15920068
...
# %% ../../nbs/30_text.core.ipynb #8c6fe844
WordTokenizer = SpacyTokenizer

# %% ../../nbs/30_text.core.ipynb #07fe7447
...
# %% ../../nbs/30_text.core.ipynb #db6e345a
...
# %% ../../nbs/30_text.core.ipynb #2862ca7b
...
# %% ../../nbs/30_text.core.ipynb #9cc97813
fn_counter_pkl = 'counter.pkl'
fn_lengths_pkl = 'lengths.pkl'

# %% ../../nbs/30_text.core.ipynb #e8acd511
...
# %% ../../nbs/30_text.core.ipynb #0089d543
...
# %% ../../nbs/30_text.core.ipynb #7fc31bc3
@delegates(_tokenize_files)
...
# %% ../../nbs/30_text.core.ipynb #df9d0d41
...
# %% ../../nbs/30_text.core.ipynb #82e68a27
...
# %% ../../nbs/30_text.core.ipynb #ebd26791
...
# %% ../../nbs/30_text.core.ipynb #849f3c16
...
# %% ../../nbs/30_text.core.ipynb #8877c10e
...
# %% ../../nbs/30_text.core.ipynb #e4893807
...
# %% ../../nbs/30_text.core.ipynb #2601f15a
eu_langs = ["bg", "cs", "da", "de", "el", "en", "es", "et", "fi", "fr", "ga", "hr", "hu",
            "it","lt","lv","mt","nl","pl","pt","ro","sk","sl","sv"] # all European langs

# %% ../../nbs/30_text.core.ipynb #ab39489f
...
# %% ../../nbs/30_text.core.ipynb #ed39f001
