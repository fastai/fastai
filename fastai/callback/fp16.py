...
# %% ../../nbs/18_callback.fp16.ipynb #f9896c74
...
# %% ../../nbs/18_callback.fp16.ipynb #03078495
class AMPMode(Enum):
    "Automatic mixed precision modes for ease of completion"
    FP16 = 'fp16'
    BF16 = 'bf16'

# %% ../../nbs/18_callback.fp16.ipynb #0be87618
...
# %% ../../nbs/18_callback.fp16.ipynb #98c2b54a
@patch
@delegates(GradScaler)
...
# %% ../../nbs/18_callback.fp16.ipynb #10f73031
@patch
...
# %% ../../nbs/18_callback.fp16.ipynb #cf9b80a3
def to_master_grads( 
...
# %% ../../nbs/18_callback.fp16.ipynb #1cfbc3f8
def to_model_params(
...
# %% ../../nbs/18_callback.fp16.ipynb #e2883daa
...
# %% ../../nbs/18_callback.fp16.ipynb #3d036a4b
@docs
...
# %% ../../nbs/18_callback.fp16.ipynb #eeb119f7
@patch
...
# %% ../../nbs/18_callback.fp16.ipynb #e7cceb45
@patch
