# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/73_callback.captum-Copy1.ipynb (unless otherwise specified).

__all__ = ['json_clean', 'CaptumInterpretation', 'json_clean', 'CaptumInterpretation']
...
def insights(x: CaptumInterpretation,inp_data,debug=True):
    ...
    # captum v0.3 expect tensors without the batch dimension.
