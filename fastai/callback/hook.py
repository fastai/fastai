...
# %% ../../nbs/15_callback.hook.ipynb #23a92668
...
# %% ../../nbs/15_callback.hook.ipynb #695267ba
@docs
class Hook():
...
# %% ../../nbs/15_callback.hook.ipynb #d4cff7d6
...
# %% ../../nbs/15_callback.hook.ipynb #75824efc
@docs
class Hooks():
...
# %% ../../nbs/15_callback.hook.ipynb #f9095457
def hook_outputs(modules, detach=True, cpu=False, grad=False):
    "Return `Hooks` that store activations of all `modules` in `self.stored`"
    return Hooks(modules, _hook_inner, detach=detach, cpu=cpu, is_forward=not grad)

# %% ../../nbs/15_callback.hook.ipynb #9106f898
...
# %% ../../nbs/15_callback.hook.ipynb #e77e2fb4
...
# %% ../../nbs/15_callback.hook.ipynb #78243619
...
# %% ../../nbs/15_callback.hook.ipynb #8d9a67ea
def has_params(m):
    "Check if `m` has at least one parameter"
    return len(list(m.parameters())) > 0

# %% ../../nbs/15_callback.hook.ipynb #6b0da791
@funcs_kwargs
...
# %% ../../nbs/15_callback.hook.ipynb #28229624
def total_params(m):
...
# %% ../../nbs/15_callback.hook.ipynb #91437a03
...
# %% ../../nbs/15_callback.hook.ipynb #43f50e47
...
# %% ../../nbs/15_callback.hook.ipynb #a7f5c85c
...
# %% ../../nbs/15_callback.hook.ipynb #3ed51c75
@patch
...
# %% ../../nbs/15_callback.hook.ipynb #836b3079
@delegates()
