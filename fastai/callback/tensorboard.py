...
# %% ../../nbs/70a_callback.tensorboard.ipynb #dfca5475
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #bf7153c7
import tensorboard
from torch.utils.tensorboard import SummaryWriter
from .fp16 import ModelToHalf
from .hook import hook_output

# %% ../../nbs/70a_callback.tensorboard.ipynb #52ba70a1
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #6badf297
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #8969902f
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #aca387df
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #9f658139
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #790ce710
def _get_embeddings(model, layer):
    layer = model[0].encoder if layer == None else layer
    return layer.weight

# %% ../../nbs/70a_callback.tensorboard.ipynb #16d30d34
@dispatch
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #f5ffdf83
from ..text.all import LMLearner, TextLearner

# %% ../../nbs/70a_callback.tensorboard.ipynb #508f4dbd
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #20b2ed09
from ..vision.data import *

# %% ../../nbs/70a_callback.tensorboard.ipynb #a75d0da8
@dispatch
...
# %% ../../nbs/70a_callback.tensorboard.ipynb #b42eb6f8
from ..vision.core import TensorPoint,TensorBBox

# %% ../../nbs/70a_callback.tensorboard.ipynb #e8d385e3
@dispatch
