...
doc_dataloader = dict(
    __init__ = r"""
        ...
        n (int): Defaults to `len(dataset)`. If you are using iterable-style dataset,
            you can specify the size of batch using `n`.
    ...
    get_idxs = r"""
        ...
        In case of iterable-style dataset, it returns a list of `[None]*n`.
        """,
    new = r"""
        Create a new `DataLoader` with the given arguments. If you have created a
        `DataLoader` with `bs=16`, you can easily create a new `DataLoader` with `bs=8`
        using `dls.new(bs=8)`. All the other arguments would be taken from `dls` and
        you can do this for any set of arguments.
        """,
    prebatched = r"""
        Property to check if we have specified `bs`. If `False` then `bs` is not `None`.
        """,
    shuffle_fn = r"""
        ...
        """,
    after_iter = r"""
        Used in iterable-style dataset.
        """,
)
...
add_docs(DataLoader, "API compatible with PyTorch DataLoader, with a lot more callbacks and flexibility",
         ...
         sample         = "TODO",
         create_batches = "TODO",
         new            = doc_dataloader['new'],
         prebatched     = doc_dataloader['prebatched'],
         do_item        = "TODO",
         chunkify       = "TODO",
         ...
         before_batch   = "TODO",
         after_batch    = "TODO",
         after_iter     = doc_dataloader['after_iter'],
)