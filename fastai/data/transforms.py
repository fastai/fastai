...
# %% ../../nbs/05_data.transforms.ipynb #b5caa3b6
...
# %% ../../nbs/05_data.transforms.ipynb #6c696e79
...
# %% ../../nbs/05_data.transforms.ipynb #6cd1b520
...
# %% ../../nbs/05_data.transforms.ipynb #129f84cd
...
# %% ../../nbs/05_data.transforms.ipynb #a1eedbc4
image_extensions = set(k for k,v in mimetypes.types_map.items() if v.startswith('image/'))

# %% ../../nbs/05_data.transforms.ipynb #af8e95b8
def get_image_files(path, recurse=True, folders=None):
    "Get image files in `path` recursively, only in `folders`, if specified."
    return get_files(path, extensions=image_extensions, recurse=recurse, folders=folders)

# %% ../../nbs/05_data.transforms.ipynb #4dffc76c
...
# %% ../../nbs/05_data.transforms.ipynb #28e21017
def get_text_files(path, recurse=True, folders=None):
    "Get text files in `path` recursively, only in `folders`, if specified."
    return get_files(path, extensions=['.txt'], recurse=recurse, folders=folders)

# %% ../../nbs/05_data.transforms.ipynb #c05c6e9f
...
# %% ../../nbs/05_data.transforms.ipynb #2685fec4
...
# %% ../../nbs/05_data.transforms.ipynb #8db45de6
...
# %% ../../nbs/05_data.transforms.ipynb #d3fa94ae
...
# %% ../../nbs/05_data.transforms.ipynb #7fc2b8e7
...
# %% ../../nbs/05_data.transforms.ipynb #e6fc1822
...
# %% ../../nbs/05_data.transforms.ipynb #9176a4f0
...
# %% ../../nbs/05_data.transforms.ipynb #35cbd0e0
def MaskSplitter(mask):
    "Split `items` depending on the value of `mask`."
    def _inner(o): return IndexSplitter(mask2idxs(mask))(o)
    return _inner

# %% ../../nbs/05_data.transforms.ipynb #a2b68532
...
# %% ../../nbs/05_data.transforms.ipynb #9e7d104c
...
# %% ../../nbs/05_data.transforms.ipynb #1a2be360
...
# %% ../../nbs/05_data.transforms.ipynb #c6452072
def parent_label(o):
    "Label `item` with the parent folder name."
    return Path(o).parent.name

# %% ../../nbs/05_data.transforms.ipynb #bdbd0140
class RegexLabeller():
...
# %% ../../nbs/05_data.transforms.ipynb #b17d3924
...
# %% ../../nbs/05_data.transforms.ipynb #1ca84285
...
# %% ../../nbs/05_data.transforms.ipynb #a0a941c5
...
# %% ../../nbs/05_data.transforms.ipynb #0f94b610
class Category(str, ShowTitle): _show_args = {'label': 'category'}

# %% ../../nbs/05_data.transforms.ipynb #f0d2d8a1
...
# %% ../../nbs/05_data.transforms.ipynb #ebbcf4de
class MultiCategory(L):
    def show(self, ctx=None, sep=';', color='black', **kwargs):
        return show_title(sep.join(self.map(str)), ctx=ctx, color=color, **kwargs)

# %% ../../nbs/05_data.transforms.ipynb #91d2ca91
...
# %% ../../nbs/05_data.transforms.ipynb #4ebe3065
...
# %% ../../nbs/05_data.transforms.ipynb #d6845860
...
# %% ../../nbs/05_data.transforms.ipynb #ce9e8295
def get_c(dls):
...
# %% ../../nbs/05_data.transforms.ipynb #4a293438
class ToTensor(Transform):
    "Convert item to appropriate tensor class"
    order = 5

# %% ../../nbs/05_data.transforms.ipynb #6c8c8a8f
...
# %% ../../nbs/05_data.transforms.ipynb #60a5dd5d
...
# %% ../../nbs/05_data.transforms.ipynb #f8188160
@docs
