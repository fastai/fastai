...
__all__ = ['get_files', 'FileGetter', 'image_extensions', 'get_image_files', 'ImageGetter', 'get_text_files',
           'ItemGetter', 'AttrGetter', 'RandomSplitter', 'TrainTestSplitter', 'IndexSplitter', 'LastSplitter',
...
# Cell
def LastSplitter(valid_pct=0.2):
    "Create function that splits `items` between train/val with `valid_pct` at the end. Useful for ordered data."
    def _inner(o):
        idxs = range_of(o)
        cut = int((1-valid_pct) * len(o))
