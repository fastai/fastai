...
__all__ = ['get_grid', 'clamp_points', 'clip_remove_empty', 'bb_pad', 'ImageBlock', 'MaskBlock', 'PointBlock',
           'BBoxBlock', 'BBoxLblBlock', 'ImageDataLoaders', 'SegmentationDataLoaders']
...
# Cell
def clamp_points(samples):
    "Clamps points to an image border"
    def _f(imgs, pnts): return imgs,torch.clamp(pnts, -1, 1)
...
# Cell
PointBlock = TransformBlock(type_tfms=TensorPoint.create, item_tfms=PointScaler, dls_kwargs= {'before_batch': clamp_points})
