...
__all__ = ['has_pool_type', 'cut_model', 'create_body', 'create_head', 'default_split', 'model_meta', 'add_head',
           'create_cnn_model', 'TimmBody', 'create_timm_model', 'cnn_learner', 'create_unet_model', 'unet_learner']
...
def cnn_learner(dls, arch, normalize=True, n_out=None, pretrained=True,
    ...
    else: model = create_cnn_model(arch, n_out, pretrained=pretrained, **kwargs)
