# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/nbs/20_interpret.ipynb (unless otherwise specified).
...
class Interpretation():
    ...
    def __init__(self,
        learn, # Model to be interpreted
        dl:DataLoader, # `DataLoader` for the model
        losses:TensorBase, # Losses calculated from the model
    ...
    def from_learner(cls,
        ...
        ds_idx:int=1, # Index of `DataLoader` when dl is None
    ...
    def plot_top_losses(self,
        k:(int,[int]), # Number of losses to plot
        largest:bool=True, # Sort losses by largest or smallest
        **kwargs
    ):
