...
__all__ = ['ParallelTrainer', 'setup_distrib', 'teardown_distrib', 'DistributedDL', 'DistributedTrainer', 'distrib_ctx']
...
def detach_distributed(self: Learner):
    ...
    if hasattr(self, 'distributed_trainer'): self.remove_cb(self.distributed_trainer)
