...
__all__ = ['CancelFitException', 'CancelEpochException', 'CancelTrainException', 'CancelValidException',
           'CancelBatchException', 'event', 'Callback', 'cb_method', 'TrainEvalCallback', 'GatherPredsCallback',
           'FetchPredsCallback']
...
# Cell
def cb_method(evt):
    "A shortcut decorator for defining a callback method"
    def _inner(f): return Callback(**{evt:method(f)})
    return _inner
