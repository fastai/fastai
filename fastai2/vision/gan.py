#AUTOGENERATED! DO NOT EDIT! File to edit: dev/24_vision.gan.ipynb (unless otherwise specified).

__all__ = ['GANModule', 'basic_critic', 'AddChannels', 'basic_generator', 'GANLoss', 'set_freeze_model', 'GANTrainer',
           'FixedGANSwitcher', 'AdaptiveGANSwitcher', 'InvisibleTensor', 'generate_noise', 'gan_loss_from_func',
           'GANLearner']
...
class GANLearner(Learner):
    ...
    def from_learners(cls, gen_learn, crit_learn, switcher=None, weights_gen=None, **kwargs):
        ...
        return cls(learn_gen.dbunch, learn_gen.model, learn_crit.model, *losses, switcher=switcher, **kwargs)
