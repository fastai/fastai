...
# Cell
def TrainTestSplitter(test_size=0.2, random_state=None, **kwargs):
    "Split items into random train and test subsets using sklearn train_test_split utility."
    def _inner(o, **kwargs):
        train, valid = train_test_split(range(len(o)), test_size=test_size, random_state=random_state, **kwargs)
