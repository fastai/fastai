...
__all__ = ['match_embeds', 'RNNLearner', 'decode_spec_tokens', 'LMLearner', 'language_model_learner',
...
# Cell
class LMLearner(RNNLearner):
    "Add functionality to `RNNLearner` when dealingwith a language model"
    @delegates(tokenize1)
