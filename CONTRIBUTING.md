...
* Before submitting, please be sure you abide by our [coding style](https://github.com/fastai/fastai/blob/master/docs-dev/style.md) and [the guide on abbreviations](https://github.com/fastai/fastai/blob/master/docs-dev/abbr.md) and clean-up your code accordingly.
