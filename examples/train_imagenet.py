...
def main( gpu:Param("GPU to run on", str)=None ):
    ...
    learn = Learner(data, models.xresnet50(), metrics=[accuracy,top_k_accuracy], wd=1e-4,
    ...
    if epoch>1: learn.load(f'model_{epoch-1}', device=torch.device('cuda', gpu))
