...
-----------------
   ...
   * [Making a Release](release.md#making-a-release)
      * [Table of Contents](release.md#table-of-contents)
      * [Release Process](release.md#release-process)
      * [Project Build](release.md#project-build)
         * [Build Source distribution / Source Release](release.md#build-source-distribution--source-release)
         * [Build Built Distribution](release.md#build-built-distribution)
         * [Build Wheel](release.md#build-wheel)
         * [Creating requirements.txt file by analyzing the code base](release.md#creating-requirementstxt-file-by-analyzing-the-code-base)
      * [Project Publish](release.md#project-publish)
      * [Prep](release.md#prep)
      * [Test Suite](release.md#test-suite)
      * [Publish](release.md#publish)
         * [PyPI](release.md#pypi)
            * [Various Helper Tools](release.md#various-helper-tools)
            * [pip Dependencies](release.md#pip-dependencies)
         * [Conda](release.md#conda)
            * [Dealing with Missing Conda Packages](release.md#dealing-with-missing-conda-packages)
            * [The Problem Of Supporting Different Architectures](release.md#the-problem-of-supporting-different-architectures)
            * [Uploading and Testing](release.md#uploading-and-testing)
               * [Test Release](release.md#test-release)
               * [Re-uploading](release.md#re-uploading)
            * [Various Helper Tools](release.md#various-helper-tools-1)
         * [Documentation](release.md#documentation)
         * [Support](release.md#support)
      * [Tagging](release.md#tagging)
      * [CI/CD](release.md#cicd)
         * [Azure DevOps CI (CPU-only)](release.md#azure-devops-ci-cpu-only)
            * [Usage](release.md#usage)
            * [Configuration](release.md#configuration)
      * [Package Download Statistics](release.md#package-download-statistics)
<!--te-->
