...
from fastai.vision.data import verify_image, COCODataset
...
def test_COCODataset(ex_json):
    ...
    assert 1 == len(test_dataset.bbox)
    assert 1 == len(test_dataset.image_id_to_bbox_id[397133])
    assert test_dataset.categories[1] == 'person'
